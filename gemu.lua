...
function PIXELBOX.ATTACH_GEMU(terminal,box)
    ...
    if not terminal.graphode then
        ...
        function terminal.setPixel(x,y,color)
            ...
            PIXELS[_MODE_][math.floor(y+1)][math.floor(x+1)] = color
            ...
            for line_index,line in ipairs(pixels) do
                ...
                if type(line) == "string" then
                    for i=1,#line do
                        ...
                        PIXELS[_MODE_][math.floor(x+i)][math.floor(y+line_index)] = CLUT[rgb]
                    end
                elseif type(line) == "table" then
                    for x_index,color in ipairs(line) do
